        ...
        <Container className="bg-gray-50 font-sans  ">
          <div className="w-[800px] border-t-[5px] border-button mx-auto  rounded-lg shadow-card overflow-hidden">
            ...
            <div className="bg-white px-6 py-8 text-gray-800">
              <h2 className="text-xl font-semibold mb-4">Estimado/a {name},</h2>
              <p className="leading-relaxed mb-4">
                Nos complace informarte que hemos recibido tu reclamación para
                la orden con número
                <strong className="text-gf"> {order}</strong>. Ya hemos
                notificado a la tienda correspondiente sobre tu solicitud.
              </p>
              <p className="leading-relaxed mb-6">
                Puedes consultar el estado de tu reclamación en cualquier
                momento haciendo clic en el botón a continuación:
              </p>
