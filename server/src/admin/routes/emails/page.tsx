...
import { CreateClaimSeller } from "../../components/email/claim-order/create-claim-seller";
import { OrderClaimUnsolved } from "../../components/email/claim-order/order-claim-unsolved";
import { PurchaseCompleted } from "../../components/email/payments/purchase-completed";
import { ApprovedApplication } from "../../components/email/state-seller-application/approved-seller-application";
import { NewSellerApplication } from "../../components/email/state-seller-application/new-seller-application";
import { CorrectionApplication } from "../../components/email/state-seller-application/correction-seller-application";
import { SentApplication } from "../../components/email/state-seller-application/sent-seller-application";
import { RejectedApplication } from "../../components/email/state-seller-application/rejected-seller-application";
import { CreateTicketCustomer } from "../../components/email/tickets/create-ticket-customer";
  ...
  return (
    <div className="w-full h-full">
      ...
      <PurchaseCompleted
        ...
        order=""
        serialCodes={[
          { serialCodes: "serial 1", title: "Netflix 1 mes " },
