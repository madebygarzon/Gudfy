...
const RegisterLight = () => {
  ...
  return (
    <div className="max-w-md w-full flex flex-col items-center">
      ...
      <h1 className="text-large-semi text-xl">Crear una cuenta</h1>
      <form
        className="w-full font[400] shadow-xl rounded-3xl px-5 py-2 flex flex-col items-center"
        onSubmit={onSubmit}
      >
        ...
        <span className="text-center text-gray-700 text-small-regular mt-2">
          <Link href={"/terms-and-conditions"}>
            Acepto los términos y condiciones.
          </Link>
        </span>
        <Button type="submit" className="mt-2 rounded-[5px]">
          Crear
        </Button>
      </form>
