    ...
    <div className="rounded-lg shadow-2xl p-8">
      ...
      <div className="sticky top-0 bg-white z-10">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="ml-7 text-xl font-extrabold">
              Productos de la tienda: ({store.variants?.length} productos total)
            </h3>
          </div>
      ...
      {/* Table with Scroll */}
      <div className="bg-white p-4 pb-4 min-h-[399px] max-h-[400px] overflow-y-auto  rounded-lg">
        <table className="w-full table-auto border-collapse">
          <thead className="sticky top-0 text-left text-gray-700 shadow-sm">
            <tr>
