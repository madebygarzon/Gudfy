      ...
      <div>
        <div className="relative z-0 w-full text-base-regular">
          <input
            ...
            placeholder=" "
            className={clsx(
              "pt-4 pb-1 block w-full px-4 mt-0 bg-transparent border-transparent appearance-none focus:outline-none focus:ring-0 focus:border-gray-400 border-gray-200",
              {
