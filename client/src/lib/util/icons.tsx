...
export function PencilEditIcon (props: ComponentProps<"svg">) {
  return (
    <svg 
...
export function EyeSeeIcon (props: ComponentProps<"svg">) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      height="24px" 
...
export function DotsIcon (props: ComponentProps<"svg">) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      height="24px" 
...
export function BlankIcon (props: ComponentProps<"svg">) {
  return (
    <svg 
      xmlns="http://www.w3.org/2000/svg" 
      height="24px" 
