...
const Contact: React.FC = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-start my-10 mx-4 sm:mx-80">
        ...
        <h2 className="text-2xl mt-2 font-bold text-gray-700 capitalize mb-4">¡Hablemos!</h2>
        <p>
        Si deseas realizar un comentario, sugerencia o una propuesta comercial, deja tu solicitud aquí 🙂
        </p>
        <form
